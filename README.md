...
Import Database: Mở MySQL Workbench, chạy file database_setup.sql trong thư mục gốc.

Config Pass: Mở LibraryManager.java, sửa DB_PASS cho đúng với mật khẩu MySQL trên máy cá nhân.

Maven Reload: Sau khi mở Project bằng IntelliJ, hãy nhấn chuột phải vào file pom.xml chọn Maven -> Reload Project để nó tự tải driver MySQL và JavaFX về.
